...
static struct msm_bus_paths bw_level_tbl_v2[] __initdata = {
	...
	[9] = BW_MBPS(8352), /* At least 1044 MHz on bus. */
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	{ 1, {  266800, PLL_0, 0,   0 },  L2(0),  755000,  72 },
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  760000,  83 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  765000, 101 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  770000, 120 },
	...
	{ 1, { 2380800, HFPLL, 1, 122 }, L2(19), 1040000, 723 },
	{ 1, { 2496000, HFPLL, 1, 126 }, L2(19), 1055000, 755 },
	{ 1, { 2611200, HFPLL, 1, 132 }, L2(19), 1070000, 787 },
	{ 1, { 2726400, HFPLL, 1, 136 }, L2(19), 1085000, 819 },
	{ 1, { 2841600, HFPLL, 1, 140 }, L2(19), 1100000, 851 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	...
	{ 1, { 2380800, HFPLL, 1, 122 }, L2(19), 1015000, 723 },
	{ 1, { 2496000, HFPLL, 1, 126 }, L2(19), 1030000, 755 },
	{ 1, { 2611200, HFPLL, 1, 132 }, L2(19), 1045000, 787 },
	{ 1, { 2726400, HFPLL, 1, 136 }, L2(19), 1060000, 819 },
	{ 1, { 2841600, HFPLL, 1, 140 }, L2(19), 1075000, 851 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	{ 1, {  266800, PLL_0, 0,   0 },  L2(0),  710000,  72 },
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  720000,  83 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  730000, 101 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  740000, 120 },
	...
	{ 1, { 2380800, HFPLL, 1, 122 }, L2(19),  990000, 723 },
	{ 1, { 2496000, HFPLL, 1, 126 }, L2(19), 1005000, 755 },
	{ 1, { 2611200, HFPLL, 1, 132 }, L2(19), 1020000, 787 },
	{ 1, { 2726400, HFPLL, 1, 136 }, L2(19), 1035000, 819 },
	{ 1, { 2841600, HFPLL, 1, 140 }, L2(19), 1050000, 851 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	{ 1, {  266800, PLL_0, 0,   0 },  L2(0),  700000,  72 },
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  710000,  83 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  720000, 101 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  730000, 120 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  740000, 139 },
	...
	{ 1, { 2380800, HFPLL, 1, 122 }, L2(19),  965000, 723 },
	{ 1, { 2496000, HFPLL, 1, 126 }, L2(19),  980000, 755 },
	{ 1, { 2611200, HFPLL, 1, 132 }, L2(19),  995000, 787 },
	{ 1, { 2726400, HFPLL, 1, 136 }, L2(19), 1010000, 819 },
	{ 1, { 2841600, HFPLL, 1, 140 }, L2(19), 1025000, 851 },
	{ 0, { 0 } }
};
...
static void __init apply_v1_l2_workaround(void)
{
	static struct l2_level resticted_l2_tbl[] __initdata = {
		[0] = { {  266800, PLL_0, 0,   0 }, LVL_LOW,  1050000, 0 },
